...
def generate_difference_mask(image_path1, image_path2, img_num, mode, strength):
    ...
    mask_path = f'C:/Users/Violet/Desktop/facial/chayi-before-resize/{mode}_{strength}/img_{img_num + 1}.webp'
...
for mode in transform_mode:
    ...
    for strength in transform_strength:
        ...
        if not os.path.exists(f'C:/Users/Violet/Desktop/facial/chayi-before-resize/{mode}_{strength}'):
         os.makedirs(f'C:/Users/Violet/Desktop/facial/chayi-before-resize/{mode}_{strength}')
        ...
        for i in tqdm(range(len(files1)), desc="生成差异图"):
            image_path1 = f'C:/Users/Violet/Desktop/facial/change_chaofen/b_0.0/img_{i + 1}.webp'
            image_path2 = f'C:/Users/Violet/Desktop/facial/change_chaofen/{mode}_{strength}/img_{i + 1}.webp'
            print(image_path1)
            print(image_path2)
...
# 使用示例
src_folder = r"C:/Users/Violet/Desktop/facial/change_chaofen\b_0.0" # 替换为源文件夹的路径
dest_folder = r"C:/Users/Violet/Desktop/facial/chayi-before-resize"  # 替换为目标文件夹的路径
