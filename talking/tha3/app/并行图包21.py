...
class units2():
    ...
    def process(self,emotion_video_path,mode,input_image_path,background_path,strength):
        ...
        #with ProcessPoolExecutor() as executor:
         ...
         for mode in transform_mode:
            ...
            if  mode=='a'or mode=='i'or mode=='u'or mode=='e'or mode=='o' :
                ...
                for strength in transform_strength:
                    futures.append(executor.submit(self.process,emotion_video_path,mode,input_image_path,background_path,strength))
...
original_image_path='tha3/app/source_imgs/14.png'#原始图片的输入路径
...
a2='beishang1.mp4'#参考表情视频的文件名（包含扩展名）
