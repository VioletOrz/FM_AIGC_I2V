...
def split_video(input_video_path, output_folder, target_fps=24, segment_frames=120):
    # 获取视频文件名（不带扩展名）
...
if __name__ == "__main__":
    input_video_path = r"F:\FM_AIGC_I2V\data\emotion\04.mp4"
    output_folder = r"F:\FM_AIGC_I2V\data\emotion"
