...
class units():
    ...
    def process_and_save_emotion_pose(self,emotion_video_path,background_output_video_path,num_frames,face_landmarker_path, emotion_pose_save_path):
    ...
    def step3(self,input_image_path,emotion_video_path,background_path,background_output_video_path,num_frames,face_landmarker_path, is_trans=False):
        img=Image.open(input_image_path)
        image_width,image_height=img.size
        parser = argparse.ArgumentParser(description='Control characters with movement captured by iFacialMocap.')
        parser.add_argument(
