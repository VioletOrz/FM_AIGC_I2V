...
class units2():
    ...
    def process(self,emotion_video_path,mode,input_image_path,background_path,img_pack_path_name,face_landmarker_path,is_trans=False):
        img=Image.open(input_image_path)
        image_width,image_height=img.size
        parser = argparse.ArgumentParser(description='Control characters with movement captured by iFacialMocap.')
        parser.add_argument(
        ...
        #with ProcessPoolExecutor() as executor:
         ...
         for mode in transform_mode:
            ...
            if  mode=='a'or mode=='i'or mode=='u'or mode=='e'or mode=='o' :
                ...
                futures.append(executor.submit(self.process,emotion_video_path,mode,input_image_path,background_path,img_pack_path_name,face_landmarker_path,is_trans))

              
            else:
                futures.append(executor.submit(self.process2,emotion_video_path,mode,input_image_path,background_path,img_pack_path_name,face_landmarker_path,is_trans))
